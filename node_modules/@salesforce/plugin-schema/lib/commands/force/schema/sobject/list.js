...
SchemaSobjectList.examples = messages.getMessage('examples').split(os.EOL);
SchemaSobjectList.flagsConfig = {
    sobjecttypecategory: command_1.flags.string({
        ...
        validate: (val) => {
            ...
            if (!result) {
                throw core_1.SfdxError.create('@salesforce/plugin-schema', 'list', 'flags.invalidTypeError');
            }
            return result;
        },
