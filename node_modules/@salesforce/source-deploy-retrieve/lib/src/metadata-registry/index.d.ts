...
export { BaseTreeContainer, NodeFSTreeContainer, VirtualTreeContainer, ZipTreeContainer, } from './treeContainers';
export { SourceComponent } from './sourceComponent';
export { MetadataRegistry, MetadataXml, SourceAdapter, TreeContainer, VirtualDirectory, TypeIndex, SuffixIndex, DirectoryIndex, DecompositionStrategy, TransformerStrategy, } from './types';
export { ForceIgnore } from './forceIgnore';
/**
 * Direct access to the JSON registry data. Useful for autocompletions.
 */
export declare const registryData: Readonly<{
    "types": {
        "installedpackage": {
            "id": string;
            "name": string;
