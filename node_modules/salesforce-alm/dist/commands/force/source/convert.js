...
exports.SourceConvertCommand = void 0;
...
class SourceConvertCommand extends ToolbeltCommand_1.ToolbeltCommand {
    async run() {
...
exports.SourceConvertCommand = SourceConvertCommand;
SourceConvertCommand.theDescription = messages.getMessage('description', null, 'source_convert');
SourceConvertCommand.longDescription = messages.getMessage('longDescription', null, 'source_convert');
SourceConvertCommand.help = messages.getMessage('help', null, 'source_convert');
SourceConvertCommand.initializeMetadataRegistry = true;
SourceConvertCommand.requiresUsername = false;
SourceConvertCommand.requiresProject = true;
SourceConvertCommand.showProgress = true;
SourceConvertCommand.flagsConfig = {
