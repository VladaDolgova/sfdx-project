...
exports.SourcePullCommand = void 0;
...
class SourcePullCommand extends ToolbeltCommand_1.ToolbeltCommand {
    constructor() {
        super(...arguments);
        this.lifecycleEventNames = ['preretrieve', 'postretrieve', 'postsourceupdate'];
    }
    async run() {
...
exports.SourcePullCommand = SourcePullCommand;
SourcePullCommand.theDescription = messages.getMessage('commandDescription');
SourcePullCommand.longDescription = messages.getMessage('commandDescriptionLong');
SourcePullCommand.help = messages.getMessage('commandHelp');
SourcePullCommand.showProgress = true;
SourcePullCommand.requiresProject = true;
SourcePullCommand.requiresUsername = true;
SourcePullCommand.flagsConfig = {
