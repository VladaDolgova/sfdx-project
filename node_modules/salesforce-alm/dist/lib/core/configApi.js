...
exports.Config.prototype.getGlobalHiddenFolder = function () {
...
exports.Config.prototype.setWorkspaceTypeDefault = function (type, username) {
    const config = {};
...
exports.Config.prototype.getConfigContentWithValidation = async function (projectDir = this.getProjectPath()) {
    const projectConfigDotJsonPath = path.join(projectDir, this.getWorkspaceConfigFilename());
 ...
 * @param projectDir The absolute path to the directory containing the workspace.
 */
exports.Config.prototype.setWorkspaceOrgConfigContent = function (projectDir, config) {
    return this.setConfigContent(srcDevUtil.getConfigFileName(), path.join(projectDir, srcDevUtil.getWorkspaceStateFolderName()), config);
};
/**
 * Updates the workspace org config object on disk.
 *
