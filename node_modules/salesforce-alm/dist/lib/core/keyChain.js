...
exports.generic_windows = exports.generic_unix = exports.darwin = exports.linux = exports.windows = exports.validateProgram = exports.platforms = void 0;
/* --------------------------------------------------------------------------------------------------------------------
...
const _errors = {
    ...
    setCredentialError: (stdout, stderr) => srcDevUtil.getError(messages.getMessage('keyChainServiceCommandFailed', `${stdout} - ${stderr}`), 'SetCredentialError'),
    getCredentialError: (stdout, stderr) => srcDevUtil.getError(messages.getMessage('keyChainServiceCommandFailed', `${stdout} - ${stderr}`), 'GetCredentialError'),
 ...
 * @private
 */
exports.validateProgram = (programPath, fsIfc, isExeIfc) => {
    let noPermission;
    try {
...
class KeychainAccess {
    ...
    validateProgram() {
        return exports.validateProgram(this.osImpl.getProgram(), this.fsIfc, _isExe);
    }
    /**
    ...
    getPassword(opts, fn, retryCount) {
        ...
        const credManager = this.osImpl.getCommandFunc(opts, child_process_1.spawn);
        let stdout = '';
        let stderr = '';
            ...
            try {
                ...
                if (e.retry) {
                    if (currentCount >= GET_PASSWORD_RETRY_COUNT) {
                        throw srcDevUtil.getError(`Failed to get the password after ${GET_PASSWORD_RETRY_COUNT} reties.`, 'RetryForGetPasswordError');
                    }
    ...
    setPassword(opts, fn) {
        ...
        exports.validateProgram(this.osImpl.getProgram(), this.fsIfc, _isExe);
        const credManager = this.osImpl.setCommandFunc(opts, child_process_1.spawn);
        let stdout = '';
        let stderr = '';
        credManager.stdout.on('data', (data) => {
            stdout += data;
...
exports.windows = new KeychainAccess(_windowsImpl, fs);
/**
...
exports.linux = new KeychainAccess(_linuxImpl, fs);
/**
 * OSX implementation
 *
...
exports.darwin = new KeychainAccess(_darwinImpl, fs);
                ...
                fs.readJson(this.getSecretFile(), (readJsonErr, readObj) => {
                    ...
                    if (_.isNil(readJsonErr)) {
                        ...
                        if (opts.service === readObj.service && opts.account === readObj.account) {
                            ...
                            fn(almError('genericUnixKeychainServiceAccountMismatch', [this.getSecretFile()], 'genericUnixKeychainServiceAccountMismatchAction', null));
                        }
                    }
                    else {
                        fn(readJsonErr);
...
exports.generic_unix = new GenericUnixKeychainAccess();
exports.generic_windows = new GenericWindowsKeychainAccess();
