...
exports.retrieveKeychainImpl = exports.DEPRECATED_KEYCHAIN = void 0;
/* --------------------------------------------------------------------------------------------------------------------
...
exports.DEPRECATED_KEYCHAIN = 'DEPRECATED_KEYCHAIN';
exports.retrieveKeychainImpl = function (platform) {
    if (!Org) {
    ...
    return BBPromise.all([_usingGenericKeychain(), Org.hasAuthentications()]).spread((isUsingGenericKeychain, hasAuthentications) => {
        ...
        if (/^win/.test(platform)) {
            if (useGenericUnixKeychain) {
                ...
                if (!isUsingGenericKeychain && hasAuthentications) {
                    ...
                    error['name'] = exports.DEPRECATED_KEYCHAIN;
