 ...
 */
declare class OrgDecorator {
    private colorEnabled;
    private chalk;
    constructor(colorEnabled?: boolean, chalkOverride?: any);
    /**
     * helper to decorate the org status
     *
     * @param {object} val - org metadata
     */
    decorateStatus(val: object): void;
    /**
     * helper to decorate the org connectedStatus
     *
     * @param {object} val - org metadata
     */
    decorateConnectedStatus(val: any): any;
    /**
