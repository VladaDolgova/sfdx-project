 ...
 * @constructor
 */
declare class OrgCreateCommand extends VarargsCommand {
    static readonly SNAPSHOT_UNSUPPORTED_OPTIONS: string[];
    static DEFAULT_POLLING_FREQ: Duration;
    private workspaceType;
    private force;
    private org;
    private scratchOrgInfoId;
    private cliContext;
    constructor();
    /**
     ...
     * @private
     */
    private signupOrgWithStreaming;
    private signupOrgWithPolling;
    /**
     ...
     * @returns {Promise}
     */
    execute(cliContext: any, stdinValues: any): Promise<any>;
    _getScratchOrgInfo(masterOrg: any, context: any): Promise<any>;
    parseSignupErrorCode(err: any): any;
    private updateRevisionCounterToZero;
    /**
     ...
     * @returns {string}
     */
    getHumanSuccessMessage(org: any): any;
    /**
     * returns a human readable error message for cli output
     *
     * @returns {string}
     */
    getHumanErrorMessage(err: any): any;
}
