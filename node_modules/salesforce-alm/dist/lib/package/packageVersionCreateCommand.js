    ...
    async _validateFlagsForPackageType(packageId, flags) {
        ...
        if (packageType == 'Unlocked') {
            if (flags.postinstallscript || flags.uninstallscript) {
                throw core_1.SfdxError.create('salesforce-alm', 'packaging', 'version_create.errorScriptsNotApplicableToUnlockedPackage');
            }
            ...
            if (ancestorId || ancestorVersion) {
                throw core_1.SfdxError.create('salesforce-alm', 'packaging', 'version_create.errorAncestorNotApplicableToUnlockedPackage');
            }
        }
    }
    /**
