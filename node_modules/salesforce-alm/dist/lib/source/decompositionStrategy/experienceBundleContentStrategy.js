...
const forceIgnore_1 = require("@salesforce/source-deploy-retrieve/lib/src/metadata-registry/forceIgnore");
...
class ExperienceBundleContentStrategy extends nonDecomposedContentStrategy_1.NonDecomposedContentStrategy {
    constructor(metadataType, metadataRegistry, workspaceVersion) {
        ...
        this.forceIgnore = forceIgnore_1.ForceIgnore.findAndCreate(core_1.SfdxProject.resolveProjectPathSync());
    }
    /**
    ...
    async saveContent(metadataFilePath, retrievedContentFilePaths, retrievedMetadataFilePath, createDuplicates, unsupportedMimeTypes, forceoverwrite = false) {
        ...
        let [newPaths, updatedPaths, deletedPaths, dupPaths] = await super.saveContent(metadataFilePath, retrievedContentFilePaths, retrievedMetadataFilePath, createDuplicates, unsupportedMimeTypes, forceoverwrite);
